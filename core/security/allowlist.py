...
class BridgeCommand(str, Enum):
    ...
    DEPLOYMENT_ENVIRONMENT_LIST = "deployment.environment.list"
    DEPLOYMENT_ENVIRONMENT_GET = "deployment.environment.get"
    DEPLOYMENT_ENVIRONMENT_BIND = "deployment.environment.bind"
    DEPLOYMENT_RELEASE_CREATE = "deployment.release.create"
    DEPLOYMENT_RELEASE_GET = "deployment.release.get"
    DEPLOYMENT_RELEASE_LIST = "deployment.release.list"
    DEPLOYMENT_PREDEPLOY_RUN = "deployment.predeploy.run"
    DEPLOYMENT_APPROVAL_SUBMIT = "deployment.approval.submit"
    DEPLOYMENT_RUN_EXECUTE = "deployment.run.execute"
    DEPLOYMENT_RUN_GET = "deployment.run.get"
    DEPLOYMENT_HEALTH_CHECK = "deployment.health.check"
    DEPLOYMENT_PROMOTE_REQUEST = "deployment.promote.request"
    DEPLOYMENT_PROMOTE_EXECUTE = "deployment.promote.execute"
    DEPLOYMENT_ROLLBACK_PROPOSE = "deployment.rollback.propose"
    DEPLOYMENT_ROLLBACK_EXECUTE = "deployment.rollback.execute"
    DEPLOYMENT_RECOVERY_RECONCILE = "deployment.recovery.reconcile"
    ...
    RUNTIME_BINDING_SET_ENABLED = "runtime_binding.set_enabled"
    RUNTIME_BINDING_RECONCILE = "runtime_binding.reconcile"
    RUNTIME_BINDING_DELETE = "runtime_binding.delete"
    QUALITY_GATE_PROFILE_LIST = "quality_gate.profile.list"
    ...
    SYSTEM_DIAGNOSTICS_COLLECT = "system.diagnostics.collect"
    ...
    SYSTEM_ONBOARDING_STATUS = "system.onboarding.status"
